...
- **De alto riesgo** (toca autenticación, facturación, migraciones de datos, o un sistema que no conoces del todo): ralentiza deliberadamente. Aquí es donde la [plantilla de PR avanzada](../templates/pr-template-advanced.md) vale su peso, y merece la pena incorporar a un segundo revisor.
